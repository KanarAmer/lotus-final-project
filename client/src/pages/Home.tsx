  ...
  return (        
      <main className={Styles["Home-Main-Section"]}>
        ...
        <section className={Styles["cards"]}>
          <div className={Styles["card"]} onClick={() => navigate('/tracker')}>
            <h3>Pregnancy tracker</h3>
            <img src={card1} alt="Pragnency tracker" />
          </div>
          <div className={Styles["card"]} onClick={() => navigate('/remainder')}>
            <h3>Tests reminder</h3>
            <img src={card2} alt="Tests reminder" />
          </div>
          <div className={Styles["card"]} onClick={() => navigate('/articles')}>
